...
function funCargarDatos(){
    ...
    $.ajax({
        ...
        $("#contenido").html("Nombre: " +respuesta.nombre +" " +respuesta.apellido +"<br>Edad: " +respuesta.edad
                                +"<br>Teléfono: " +respuesta.telefono +"<br>Dirección: " +respuesta.direccion);
...
// $ este signo hace como el llamado de document.getelement asi y sw llama a todo lo que queremos 